...
// Дан **отсортированный (упорядоченный от меньшего к большему) **массив целых чисел `nums`
// и целое число `target`.
//
// Необходимо проверить, есть ли в массиве заданное число,
// если есть - напечатать  его индекс, если нет, напечатать -1.
